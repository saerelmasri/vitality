...
const {createCompetition, sendInvition, showAllInvitations, changeStatusInvitation, performing_competition, getWinner } = require('../controllers/competition.controllers')
